...
<body class="font-sans bg-gray-300">
    ...
    <section class="container mx-auto py-16 w-3/4">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div class="flex flex-col items-center justify-center">
          <h3 class="text-2xl font-semibold mb-2 text-blue-600">Discover Our Services</h3>
          <p class="text-gray-700">Explore a wide range of services tailored to your needs. From consultation to
            execution, we have you covered.</p>
        </div>
        <!-- Grid Item 2 -->
        <div class="flex flex-col items-center justify-center">
  ...
  <section class="pb-16 w-3/4 mx-auto text-center space-y-6">
    <div class="text-3xl text-blue-600">Ancaman dosa RIBA sangat mengerikan dan menakutkan. Bagaimana solusinya ?</div>
    <div class="text-sm">lorem oeijroiejroiejro ijeoijroeijro ijeirj ldskjflksdj lfkjsdlkfj lskdjf lksjdlkf jsdlkjf
      lksjdlfk jsdlkjf lskdjf lksjdflk sjdlkf jsldkjf s dlkfjsldkj flksjd foijsdo ijfosdijf oijsdoijfosi jdfoijs oidjfo
      isjdofi jsdoijf osijdfo isdjfio jsdoifj osdijf oisdjf oisdjfo isjdfoi jsdoijf </div>
  </section>
        ...
        <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-3ffcb3e1"
          ...
          <div class="elementor-widget-wrap elementor-element-populated">
            <div
              ...
              <div class="elementor-widget-container">
                <img data-lazyloaded="1" data-placeholder-resp="768x501"
                  src="https://www.marifa.id/wp-content/uploads/2022/10/Siteplan-Skyland-Ponorogo-Juli-2022-768x501.png"
                  decoding="async" width="768" height="501"
                  data-src="https://www.marifa.id/wp-content/uploads/2022/10/Siteplan-Skyland-Ponorogo-Juli-2022-768x501.png"
                  class="attachment-medium_large size-medium_large wp-image-18 entered litespeed-loaded" alt=""
                  data-srcset="https://www.marifa.id/wp-content/uploads/2022/10/Siteplan-Skyland-Ponorogo-Juli-2022-768x501.png 768w, https://www.marifa.id/wp-content/uploads/2022/10/Siteplan-Skyland-Ponorogo-Juli-2022-300x196.png 300w, https://www.marifa.id/wp-content/uploads/2022/10/Siteplan-Skyland-Ponorogo-Juli-2022.png 804w"
                  data-sizes="(max-width: 768px) 100vw, 768px" data-ll-status="loaded"
                  sizes="(max-width: 768px) 100vw, 768px"
                  srcset="https://www.marifa.id/wp-content/uploads/2022/10/Siteplan-Skyland-Ponorogo-Juli-2022-768x501.png 768w, https://www.marifa.id/wp-content/uploads/2022/10/Siteplan-Skyland-Ponorogo-Juli-2022-300x196.png 300w, https://www.marifa.id/wp-content/uploads/2022/10/Siteplan-Skyland-Ponorogo-Juli-2022.png 804w">
              </div>
            </div>
          </div>
        </div>
        <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-102661b0"
          ...
          <div class="elementor-widget-wrap elementor-element-populated">
            ...
            <div
              ...
              <div class="elementor-widget-container">
                <h2 class="elementor-heading-title elementor-size-default text-3xl font-semibold mb-4 text-white">Marifa Skyland
                  <br>Beduri Ponorogo
                </h2>
              </div>
            </div>
            <div
              ...
              <div class="elementor-widget-container">
                <h5 class="elementor-heading-title elementor-size-default text-white">Cocok untuk hunian dan investasi karena harga
        ...
        <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-1a1a5c14"
          ...
          <div class="elementor-widget-wrap elementor-element-populated">
            ...
            <div
              ...
              <div class="elementor-widget-container">
                <h2 class="elementor-heading-title elementor-size-default text-3xl font-semibold mb-4 text-white">Berapa Jarak Lokasi Perumahan Dengan Fasilitas
                  umum?</h2>
              </div>
            </div>
            <div
        ...
        <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-6d33338f"
          ...
          <div class="elementor-widget-wrap elementor-element-populated">
            <div
              ...
              <div class="elementor-widget-container">
                <img data-lazyloaded="1" data-placeholder-resp="768x542"
                  src="https://www.marifa.id/wp-content/uploads/2022/10/maps-lokasi-Marifa-Skyland-768x542.png"
                  decoding="async" width="768" height="542"
                  data-src="https://www.marifa.id/wp-content/uploads/2022/10/maps-lokasi-Marifa-Skyland-768x542.png"
                  class="attachment-medium_large size-medium_large wp-image-19 entered litespeed-loaded"
                  alt="Terbaik dalam Menentukan Lokasi Perumnas Ponorogo"
                  data-srcset="https://www.marifa.id/wp-content/uploads/2022/10/maps-lokasi-Marifa-Skyland-768x542.png 768w, https://www.marifa.id/wp-content/uploads/2022/10/maps-lokasi-Marifa-Skyland-300x212.png 300w, https://www.marifa.id/wp-content/uploads/2022/10/maps-lokasi-Marifa-Skyland.png 785w"
                  data-sizes="(max-width: 768px) 100vw, 768px" data-ll-status="loaded"
                  sizes="(max-width: 768px) 100vw, 768px"
                  srcset="https://www.marifa.id/wp-content/uploads/2022/10/maps-lokasi-Marifa-Skyland-768x542.png 768w, https://www.marifa.id/wp-content/uploads/2022/10/maps-lokasi-Marifa-Skyland-300x212.png 300w, https://www.marifa.id/wp-content/uploads/2022/10/maps-lokasi-Marifa-Skyland.png 785w">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-6bc29f2"
        ...
        <div class="elementor-widget-wrap elementor-element-populated">
            ...
            <div style="height: 400px">
              <div class="elementor-wrapper elementor-open-inline" style="height: 400px">
                <iframe frameborder="0"
                  allowfullscreen="1"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  title="Perumahan di Ponorogo PERUMAHAN ELIT - HARGA IRIT Marifa Skyland Kota Ponorogo" width="640"
                  height="400"
                  src="https://www.youtube.com/embed/itRoaEaqX_Q?controls=1&amp;rel=0&amp;playsinline=0&amp;modestbranding=0&amp;autoplay=0&amp;enablejsapi=1&amp;origin=https%3A%2F%2Fwww.marifa.id&amp;widgetid=13"
          ...
          <div
            ...
            <div class="elementor-widget-container">
              <h2 class="elementor-heading-title elementor-size-default text-3xl font-semibold mb-4 text-white"><b><b>Video Tour Marifa Skyland</b></b></h2>
            </div>
          </div>
          <div
            ...
            <div class="elementor-widget-container">
              <h6 class="elementor-heading-title elementor-size-default text-3xl font-semibold mb-4 text-white" style="color: #fae1b3;"><b><b>SMARTHOME + ROOFTOP + PRIVATE POOL</b></b>
              </h6>
            </div>
          </div>
          <div
            ...
            <div class="elementor-widget-container">
              <h6 class="elementor-heading-title elementor-size-default text-white"><b><b>Perumahan Elit, Rumah Mewah, Harga Irit,
          ...
          <div
            ...
            <div class="elementor-widget-container">
              <h2 class="elementor-heading-title elementor-size-default text-4xl font-semibold mb-4 text-white" style="color: #fae1b3;"><b><b>Harga Mulai 800 jutaan. Bisa diangsur Tanpa
                    Riba Sampai 15 tahun.</b></b></h2>
            </div>
          </div>
          <div
          ...
          <div
            ...
            <div class="elementor-widget-container">
              <div class="elementor-button-wrapper"><b><b>
                    <a class="elementor-button elementor-button-link elementor-size-sm bg-blue-700 text-white" href="#">
